...
class AsyncStrictIota:
    ...
    def create_command(self, command: Text) -> CustomCommand:
        """
    ...
    async def add_neighbors(self, uris: Iterable[Text]) -> Dict:
        """
    ...
    async def remove_neighbors(self, uris: Iterable[Text]) -> Dict:
        """
