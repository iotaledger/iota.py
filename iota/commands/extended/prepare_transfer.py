...
class PrepareTransferCommand(FilterCommand):
    ...
    def _execute(self, request):
        ...
        # Optional parameters.
        change_address = request.get('changeAddress')
        proposed_inputs = request.get('inputs')
            ...
            if proposed_inputs is None:
                ...
                for i, balance in enumerate(gb_response.get('balances') or []):
                    ...
                    if balance > 0:
                        ...
                        # Update the address balance from the API response,
                        # just in case somebody tried to cheat.
