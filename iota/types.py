...
# from typing import Any, AnyStr, Generator, Iterable, Iterator, List, MutableSequence, Optional, Text, Union
...
class TryteString(JsonSerializable):
  ...
  """
    ...
    """
        ...
        return cls(
            ''.join(chr(generator.choice(alphabet)) for _ in range(length)).encode('ascii')
        )
