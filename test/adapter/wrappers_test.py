...
class RoutingWrapperTestCase(TestCase):
    ...
    """
        ...
        wrapper = (RoutingWrapper(default_adapter).add_route('attachToTangle', pow_adapter).add_route('interruptAttachingToTangle', pow_adapter))  # noqa:E501
    ...
    """
        ...
        wrapper1.add_route('alpha', 'http://localhost:14265').add_route('bravo', 'http://localhost:14265')
